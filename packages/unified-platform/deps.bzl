...
def unified_platform_deps():
    ...
    go_repository(
        ...
        sum = "h1:s3eRy+hYmu5uzotB6ZhDofgHu8kDgGN/fpmjxRkqSpk=",
        version = "v2.46.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:B4aV4OsfzbrS5rvjILt4mMjiWBA//cKxJUMsvHZ8mEI=",
        version = "v1.6.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5VipnvEpbqr2gA2VbM+nYVbkIF28c5ZQfqCBQ5g2xfk=",
        version = "v2.29.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pSdJYLOVgLE8YdUY2FHQ1Fxu+aMnb6JfVz1mxk7OeMU=",
        version = "v0.40.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IQRWgT5srOCYfiWnpqUYz9CVmbO8bFmKcwYxpuCSL2g=",
        version = "v1.10.0",
    )
    go_repository(
