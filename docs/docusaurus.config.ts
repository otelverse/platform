...
const config: Config = {
  title: 'OTelVerse',
  tagline: 'OpenTelemetry, Unified.',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://docs.otelverse.io',
  ...
  organizationName: 'otelverse', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/otelverse/platform/tree/main/docs/',
        },
        blog: {
